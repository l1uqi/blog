...
> 经验声明：本文是 AI 编程协作系列的第三篇。前面先讲了为什么很多人用不好 AI 编程工具，也把 LLM、Token、Context、Tool、MCP、Agent 和 Skill 这些基础词说清楚了。这一篇重点讨论项目 Rules。

## 先抓住这篇的模型

Rules 最容易被写成口号，但真正有用的 Rules 应该来自真实错误。它不是为了让 AI “更听话”，而是为了把项目里反复出现的边界沉淀下来。
...
判断一条 Rule 有没有价值，可以先问三个问题：

| 问题 | 好 Rule 的答案 |
| --- | --- |
| 它是否来自具体场景 | 是，能说清楚曾经踩过什么坑 |
| 它是否可执行 | 是，AI 能据此改变操作 |
| 它是否有边界 | 是，知道什么时候适用，什么时候不适用 |
...
- 上一篇：[Skill：把经验沉淀成操作手册](/blog/2026/03/14/Skill：把经验沉淀成操作手册/)
- 下一篇：[为什么模型 Context 决定 AI 编程效果](/blog/2026/03/21/为什么模型Context决定AI编程效果/)
