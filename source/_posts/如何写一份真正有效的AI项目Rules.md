...
上一篇文章里我提到，很多人用不好 AI 编程工具，一个很重要的原因是 **Rules 几乎没有**。
...
- 上一篇：[AI 编程新人先懂这几个词：LLM、Token、Context、Tool、MCP 和 Skill](/2026/02/25/AI编程新人先懂这几个词：LLM、Token、Context、Tool、MCP和Skill/)
- 下一篇：[为什么模型 Context 决定 AI 编程效果](/2026/03/18/为什么模型Context决定AI编程效果/)
